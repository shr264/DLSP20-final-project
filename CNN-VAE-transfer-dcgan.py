...
for epoch in range(0, epochs + 1):
    ...
    if test_loss_post < best_loss:
        ...
        torch.save(best_model.state_dict(), 
                   'models/CNNVAE_transfer_BB_dcgan_model.pth')
    ...
    plt.savefig("imgs/CNNVAE_transfer_dcgan_plot_epoch_"+str(epoch)+".png", dpi=150)
    plt.close(fig)
    
pd.DataFrame(accuracy_list).to_csv('CNNVAE_transfer_dcgan_accuracy_list.csv')

torch.save(codes, "CNNVAE_transfer_dcgan_codes.dict")
