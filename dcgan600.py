...
for e in range(epochs):
    ...
    #for batch_idx, (sample, target, road_image, extra) in enumerate(trainloader):
        ...
        if (batch_idx % print_every == 0):
            ...
            plt.savefig("/scratch/shr264/myjupyter/dl-project-private/code/imgs/DCGAN_600_generator_batch_"+str(batch_idx)+"_.png", dpi=150)
    ...
    if (e % plot_every == 0):
        ...
        plt.legend()
        plt.savefig("/scratch/shr264/myjupyter/dl-project-private/code/imgs/DCGAN_600_losses_epoch_"+str(e)+"_.png", dpi=150)
        torch.save(G.state_dict(), "/scratch/shr264/myjupyter/dl-project-private/code/models/DCGAN_600_G_generator_epoch_"+str(e)+".pth")
        torch.save(D.state_dict(), "/scratch/shr264/myjupyter/dl-project-private/code/models/DCGAN_600_D_generator_epoch_"+str(e)+".pth")
