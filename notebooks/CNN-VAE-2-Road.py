...
for epoch in range(0, epochs + 1):
    ...
    plt.savefig("imgs/CNNVAE_ROAD_plot_epoch_"+str(epoch)+".png", dpi=150)
    plt.close(fig)
    
pd.DataFrame(accuracy_list).to_csv('CNNVAE_ROAD_accuracy_list.csv')

torch.save(codes,"CNNVAE_ROAD_codes.dict")
