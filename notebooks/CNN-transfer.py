...
for epoch in range(0, epochs + 1):
    ...
    if test_loss < best_loss:
        ...
        torch.save(best_model.state_dict(), 
                   'models/CNN_transfer_BB_model.pth')
    ...
    plt.savefig("imgs/CNN_transfer_plot_epoch_"+str(epoch)+".png", dpi=150)
    plt.close(fig)
    
pd.DataFrame(accuracy_list).to_csv('CNN_transfer_accuracy_list.csv')
